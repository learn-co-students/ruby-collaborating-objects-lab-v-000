class Song
  ...
  # We want to send the artist's name (a string--remember we are getting this
  # from the parsed filename) to the Artist class to achieve the functionality
  # described above in #1 and #2. Let's call this method Artist.find_or_create_by_name(artists-name-here).
  #
